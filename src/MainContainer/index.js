...
import "./Main.scss";
import { containersInfo } from "./subContainersInfo";
import SubContainer from "./subContainers";

function MainContainer() {
  const containers = containersInfo.map((el, index) => {
    const btn = index === 0;
...
/*
     <div className="section_one_container">
          ...
          <div className="col_two">
            ...
            <div id="text">
              If you want to increase comfort and lower your carbon footprint,
        ...
        <div className="section_two_container left">
          ...
          <div className="col_two">
            ...
            <div id="text">
              Track the quality, age and efficiency of the key factors that
        ...
        <div className="section_two_container right">
          ...
          <div className="col_two">
            ...
            <div id="text">
              Instead of an expensive, in-person energy audit, use your smart
        ...
        <div className="section_two_container left">
          ...
          <div className="col_two">
            ...
            <div id="text">
              Get a customized timeline that shows you when to do asset upgrades
        ...
        <div className="section_two_container right">
          ...
          <div className="col_two">
            ...
            <div id="text">
              Learn about all the ways to electrify your house, including the
        ...
        <div className="section_two_container left">
          ...
          <div className="col_two">
            ...
            <div id="text">
              Know when financial incentives change, and be aware of special
