        ...
        <div className="item_container">
          <div className="img_sub">
            <div className="electri_box">
              <img className="img" src="../Electrify/EnergyGeneration.svg" />
            </div>
            <div className="electri_text">Impacts Electrification Rating</div>
          </div>
          <div className="text_sub">
            <div className="p1">
              Rooftop solar is often the first thing people consider when trying
              to find ways to reduce their carbon footprint, and it makes sense.
            </div>
            <div className="p2">
              {" "}
              At Electricasa, we like to think big, and that’s why we recommend
