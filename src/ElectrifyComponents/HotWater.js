  ...
  return (
    <div>
      ...
      <div className="electrify_container">
        <div className="h3">Hot Water</div>
        <div className="item_container">
          <div className="img_sub">
            <div className="electri_box">
              <img className="img" src="../Electrify/HotWater.svg" />
            </div>
            <div className="electri_text">Impacts Electrification Rating</div>
          </div>
          <div className="text_sub">
            <div className="p1">
              Approximately 18-30% of residential home energy usage is for hot
              water. Water can be heated with gas or electricity.
            </div>
            <div className="p2">
              Most water heaters use gas, because it has been, until recently,
            ...
            <div className="p3">
              The advantage of heat pump water heaters is that they can be
