        ...
        <div className="item_container">
          <div className="img_sub">
            <div className="electri_box">
              <img className="img" src="../Electrify/Cooking.svg" />
            </div>
            <div className="electri_text">Not Currently Included in Rating</div>
          </div>
          <div className="text_sub">
            <div className="p1">
              Some people love cooking with gas and don’t believe it’s possible
              there could be a better way. That is a fair opinion. From a
            ...
            <div className="p2">
              A true all electric home with zero emissions would exclude gas for
              cooking. Luckily, there are excellent alternatives. Induction
              cooktops are more efficient than gas. They are safer and faster.
